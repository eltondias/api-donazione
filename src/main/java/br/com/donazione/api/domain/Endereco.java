...
public class Endereco implements Serializable {
    ...
    public Endereco latitude(String latitude) {
    ...
    public Endereco longitude(String longitude) {
    ...
    public Endereco voluntario(Voluntario voluntario) {
    ...
    public Endereco acao(Acao acao) {
        this.acao = acao;
        return this;
    }
